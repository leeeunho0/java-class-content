...
// 버튼을 클릭했을때 글을 입력했을 때 뭔가 사용자가 행동을 했을 때 동작하는 것! 이벤트!
public class EventTest {
	...
	public EventTest() {
		...
		JButton 빨강버튼 = new JButton("빨강버튼");
		JButton 파랑버튼 = new JButton("파랑버튼");
		...
		빨강버튼.addActionListener(e->{
			System.out.println("빨간버튼 선택!");
		});
		
		파랑버튼.addActionListener(e->{
