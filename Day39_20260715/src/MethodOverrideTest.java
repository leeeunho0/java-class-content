...
class 교촌치킨 extends 배달주문가게{
	...
	// 고객들이 주문하면 치킨을 만들고 배달하시는 라이더분들께 만든 치킨을 줘야한다.
	// 함수를 실행했을 때 결과가 있니? 돌려줄게 있니?
	String 주문하기(String 고객주문메뉴){
		System.out.println("교촌치킨 만드는방법");
		System.out.println("치킨을 밀가루에");
		System.out.println("온도는 180도");
		System.out.println("기름털고 상자");
		System.out.println("라이더에게 전달");
		return "고객이 주문한 치킨완성";
	}
}

	// 고객들이 주문하면 치킨을 만들고 배달하시는 라이더분들께 만든 치킨을 줘야된다.
...
public class MethodOverrideTest {
	...
	public static void main(String[] args) {
		// 실제 가게!
		교촌치킨 동탄9동 = new 교촌치킨("동탄9동","000-1111-1111");
