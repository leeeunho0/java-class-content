...
// private은 객체를 생성할 때 자물쇠가 열려있다.
		// 객체를 생성할때 자동으로 값을 저장하는 매개변수 받는 생성자가 필요한거다!
		// 게임 캐릭터 생성해서 게임을 들어가면 자동으로
		// 레벨1 목숨 150 알아서 세팅?

		플레이어 영희 = new 플레이어();
		
		// private 막아버리니깐 main 플레이어 레벨확인해서 화면에 레벨을 띄워야된다. 그런데 막혔다..
		// 그래서 main이 부탁한다. 레벨에서 목숨을 확인할 수 있게 방법을 줄래?
		// get기법
